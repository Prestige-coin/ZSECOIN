ZSEcoin-qt: Qt4 GUI for ZSEcoin
===============================
...
Alternatively, install Qt Creator and open the `ZSEcoin-qt.pro` file.

An executable named `ZSEcoin-qt` will be built.
...
A warning for people using the *static binary* version of ZSEcoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of ZSEcoin is linked against libdb5.3.
...
installed causes ZSEcoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
