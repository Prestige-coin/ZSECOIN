...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZSE");
    case mBTC: return QString("mZSE");
    case uBTC: return QString::fromUtf8("μZSE");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("ZSEcoins"));
    case mBTC: return QString(QObject::tr("Milli-ZSEcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-ZSEcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
