...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 1, std::make_pair(uint256("0x00000946eaf8bfa6696e994c93aa62b284be8ddf06b7aff19bde8e2f0ea9ba0c"), 1364674052) )
	    ( 29, std::make_pair(uint256("0x000002322de68cb19d61feadaff6aafbdd6f1ae00a4a11077dd4b92f8899a3e5"), 1364674052) )
    ;
