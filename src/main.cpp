...
const string strMessageMagic = "ZSEcoin Signed Message:\n";
...
{
    int64_t nRewardCoinYear = 8 * CENT;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ZSEcoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // ZSEcoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZSEcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "ZSEcoin Genesis Block";
        CTransaction txNew;
        txNew.nTime = 1475526795;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1475526796;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 268867; // !fTestNet ? 1575379 : 46534;
		

        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x4e4f1ec647e5ce690cf0cbe0b6cf5c01fff2ffda9bfdd4034d23b8e2dda30cb8"));
...
unsigned char pchMessageStart[4] = { 0xb9, 0x98, 0xe2, 0xf5 };
